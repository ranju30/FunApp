...
describe('tenCroreToNineNine', function() {
    describe('represent', function() {
        ...
        it('should return the word for 100000000', function() {
            var ans = tenCroreToNineNine.represent(100000000);
            assert.equal(ans, 'ten crore');
        });
        it('should return the word for 103152320', function() {
        ...
        it('should return the word for 201509720', function() {
        ...
        it('should return the word for 561903247', function() {
        ...
        it('should return the word for 701836437', function() {
        ...
        it('should return the word for 998103794', function() {
        ...
        it('should return the word for 000000001', function() {
            var ans = tenCroreToNineNine.represent(000000001);
            assert.equal(ans, 'one');
        });
        it('should return the word for 100000001', function() {
